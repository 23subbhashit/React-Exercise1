        ...
        <table id="cart" className="table table-hover table-condensed">
          <thead>
            <tr>
              ...
              <th style={{ width: '8%', color: '#DA70D6' }}>Quantity</th>
              <th style={{ width: '22%', color: '#DA70D6' }} className="text-center">Subtotal</th>
                ...
                <td data-th="Product">
                  <div className="row">
                    ...
                    <div className="col-sm-10 col-8">
                      <h4 className="nomargin" style={{ color: 'purple' }}>{item.name}</h4>
          ...
          <tfoot>
            <tr className="visible-xs">
              <td className="text-center"><strong>Delivery By 2nd October 2023</strong></td>
